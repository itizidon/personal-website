    ...
    <div className="projectsPadding">
      <div className="comps" id="projects">
        <div className="contents">
          ...
          <p>
            Stack: GraphQL | Express | React | Redux | Node.js | PostgreSQL |
            Cypress
          </p>
          <a href="https://watchbuddy-frontend.herokuapp.com/">Checkout</a>
        </div>
        <div className="contents" id="stackadonId">
          <p>
            <img
              src={stackadon}
              height={'200px'}
          ...
          <p>
            Stack: Express | React | Redux | Node.js | PostgreSQL | Socket.io
          </p>
        ...
        <div className="contents">
          ...
          <p>Stack: Electron | React | Redux | Node.js | FlowJS</p>
      ...
      <div className="video">
        <div className="inVideo">
          ...
          <p>
          Stack: React-Native | Redux | Node.js | PostgreSQL | Edamam | Spoonacular |
            Sequelize | Express{' '}
          </p>
